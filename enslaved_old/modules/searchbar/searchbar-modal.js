...
var hidden_modals = document.getElementsByClassName('modal-view-module');
...
function showModal(i) {
    ...
    return function(){
        ...
        setTimeout(function(){
            $('.modal-view-module').css('background', 'rgba(13, 18, 48, 0.7)');
            setTimeout(function(){
...
$(".modal-view-module").click(closeModal);
...
function closeModal () {
    ...
    setTimeout(function(){
        $('.modal-view-module').css('background', 'rgba(13, 18, 48, -0.3)');
        setTimeout(function(){
            $(".modal-view-module").css('display', '');
            $(".modal-view-module").css('height', '');
        }, 150);
    }, 100);
}
