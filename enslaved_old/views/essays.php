...
<div class="container about essays">
    <div class="container aboutwrap">
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Volutpat sed cras ornare arcu dui. Ac tortor vitae purus faucibus ornare. Ultricies mi.</p>
    </div>
</div>
<!--  Featured Essays container  -->
<div class="container column essaycard">
    <div class="container cardwrap">
        <h2 class="column-header">Featured Essays</h2>
        <ul class="row">
            <li>
                <a>
...
<div class="container column essaymultiplerowcards">
    <div class="container cardwrap">
        <h2 class="column-header">All Essays</h2>
        <ul class="row">
            <li>
                <a>
                    <div class="container cards">
