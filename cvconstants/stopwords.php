...
const stopwords = [
    ...
    "could","couldn't","de","detail","do","done","down",
    ...
    "former","formerly","forty","four","from","front","full","further",
    ...
    "several","she","should","side","since","six","sixty","so",
    "some","somehow","someone","something","sometime","sometimes","somewhere",
    "still","such","take","ten","than","that","the","their","them",
