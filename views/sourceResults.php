    ...
    <h4 class="last-page-header"><a id="last-page" href="<?php echo BASE_URL;?>exploreSources"><span id="previous-title">Sources // </span></a><a id="last-page" href="<?php echo BASE_URL;?>peopleSub2"><span id="previous-title">Format // </span></a><span id="current-title">Image</span></h4>
        ...
        <div class="heading-search">
            <form class="search-form">
                ...
                <input id="searchbar" class="search-field main-search" type="text" name="searchbar" placeholder="Search Across 6,000 Image Results"/>
        ...
        <ul>
            ...
            <ul class="catmenu" id="submenu">
                ...
                <li>
                    <label>
                        <input id="checkBox" type="checkbox">
                        <img src="<?php echo BASE_URL;?>assets/images/Project-dark.svg" alt="project icon alt="arrow"">
                        <p>Projects</p>
                        <span></span>
                    </label>
                </li>
