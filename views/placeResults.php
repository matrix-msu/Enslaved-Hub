    ...
    <h4 class="last-page-header"><a id="last-page" href="<?php echo BASE_URL;?>explorePlaces/"><span id="previous-title">Places // </span></a><a id="last-page" href="<?php echo BASE_URL;?>peopleSub2"><span id="previous-title">Place Type // </span></a><span id="current-title">Port</span></h4>
        ...
        <div class="heading-search">
            <form class="search-form">
                ...
                <input id="searchbar" class="search-field main-search" type="text" name="searchbar" placeholder="Search Across 6,000 Port Results"/>
...
<main class="search-results">
    <div class="filter-menu">
        <ul>
            ...
            <!-- General Filtering -->
            <hr>
            <li class="cat-cat">General Filtering<span class="align-right">< alt="arrow" src="<?php echo BASE_URL;?>assets/images/Arrow-dark.svg" alt="arrow"></span>
            </li>
            <ul id="mainmenu">
