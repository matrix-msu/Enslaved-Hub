...
<div class="container explore-by">
    ...
    <ul class="cards">
        <li>
            <a href="<?php echo BASE_URL?>eventsSub/?type=Event Type">Event Type<div id="arrow"></div></a>
        </li>
        <li>
            <a href="<?php echo BASE_URL?>eventsSub/?type=Time">Time<div id="arrow"></div></a>
        </li>
        <li>
            <a href="<?php echo BASE_URL?>eventsSub/?type=Place">Place<div id="arrow"></div></a>
        </li>
    </ul>
</div>
<!-- Featured Events -->
...
<div class="explore-search">
    ...
    <form class="search-form">
        ...
        <input id="searchbar" class="search-field main-search" type="text" name="searchbar" placeholder="Start Searching for Events By Crew, Event Type, Rig, Captain, Etc."/>
