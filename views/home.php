    ...
    <div class="container middlewrap home-page">
        ...
        <div class="heading-search">
            ...
            <form class="search-form" action="<?= BASE_URL ?>search/all">
                ...
                <input id="searchbar" class="search-field main-search" type="text" name="searchbar" placeholder="Search People, Events, Places, and Sources"/>
    ...
    <section class="section section-epp">
        <div class="section-content">
            <div class="row">
                    ...
                    <p class="paragraph"><?php echo array_key_exists("Explore", $cache_data) ? $cache_data["Explore"] : "" ?></p>
                    <!--<p class="paragraph">Enslaved Publishing Platform is a digital academic journal that publishes original, peer-reviewed datasets about the lives of enslaved Africans and their descendants drawn from the documents produced from the fifteenth to the early twentieth centuries.</p>-->
