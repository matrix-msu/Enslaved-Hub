            ...
            case 'people':
                ...
                $connections = '<div class="connectionswrap"><p>Person\'s Connections</p><div class="connections">';
                	if (intval($countpeople) > 0){
                        $connections .= '<div class="card-icons"><img src="../assets/images/Person-dark.svg" alt="Person Connections Icon"><span class="tooltip" id="person"><span class="head">Person</span></span><span>'.$countpeople.'</span><div class="connection-menu">'.$connection_lists[0].'</div></div>';
                    }
                    if (intval($countplace) > 0){
                        $connections .= '<div class="card-icons"><img src="../assets/images/Place-dark.svg" alt="Place Connections Icon"><span class="tooltip" id="place"><span class="head">Place</span></span><span>'.$countplace.'</span><div class="connection-menu">'.$connection_lists[1].'</div></div>';
                    }
                    if (intval($countevent) > 0){
                        $connections .= '<div class="card-icons"><img src="../assets/images/Event-dark.svg" alt="Event Connections Icon"><span class="tooltip" id="event"><span class="head">Event</span></span><span>'.$countevent.'</span><div class="connection-menu">'.$connection_lists[2].'</div></div>';
                    }
                    if (intval($countsource) > 0){
                        $connections .= '<div class="card-icons"><img src="../assets/images/Source-dark.svg" alt="Source Connections Icon"><span class="tooltip" id="source"><span class="head">Source</span></span><span>'.$countsource.'</span><div class="connection-menu">'.$connection_lists[3].'</div></div>';
                    }
                $connections .= '</div></div>';
