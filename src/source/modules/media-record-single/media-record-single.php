...
<script type="text/javascript" src="<?php echo BASE_MODULE_URL;?>media-record-single/media-record-single.js"></script>
<script type="text/javascript" src="<?php echo BASE_MODULE_URL;?>media-record-single/media-modal.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo BASE_MODULE_URL;?>media-record-single/media-record-single.css">
