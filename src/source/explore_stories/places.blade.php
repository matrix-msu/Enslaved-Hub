...
<div class="container header stories">
    <div class="image-container exploreFilters-page image-only">
      ...
      <div class="container middlewrap">
          ...
          <h4 class="last-page-header"><a id="last-page" href="<?php echo BASE_URL;?>stories/"><span id="previous-title">Stories / </span></a><span id="current-title">Place</span></h4>
          <h1>Place</h1>
      </div>
...
<div class="explore-by">
    <ul class="cards">
      ...
      foreach ($options as $option => $count) { ?>
          <li>
              <a href='<?php echo BASE_URL;?>stories/all/?filters={"Place":["<?=$option?>"]}'>
